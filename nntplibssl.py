...
__all__ = ["NNTPBase","NNTP","NNTP_SSL","NNTPReplyError","NNTPTemporaryError",
...
# The class itself
class NNTPBase:
    def __init__(self, host, sock, user=None, password=None,
                 readermode=None, usenetrc=True):
        """Initialize an instance.  Arguments:
        - host: hostname connected to
        - sock: already-connected socket or socket-like object
...
# Plaintext version of NNTP class
class NNTP(NNTPBase):
    def __init__(self, host, port=NNTP_PORT, user=None, password=None,
        ...
        NNTPBase.__init__(self, host, sock, user, password, readermode, usenetrc)

# SSL-enabled version of NNTP class
try:
    import ssl
except ImportError:
    pass
else:
    class NNTP_SSL(NNTPBase):
        def __init__(self, host, port=NNTP_SSL_PORT,
            ...
            """Initialize an instance.  Arguments:
            - host: hostname to connect to
            - port: port to connect to (default the standard NNTPS port)
            ...
            self.real_sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
            self.real_sock.connect((self.host, self.port))
            sock = ssl.wrap_socket(self.real_sock, keyfile, certfile)
            NNTPBase.__init__(self, host, sock, user, password, readermode, usenetrc)
